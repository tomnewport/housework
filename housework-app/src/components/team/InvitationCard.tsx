...
export default function InvitationCard({
  ...
  invitation: components["schemas"]["InvitationSchema"];
}) {
  ...
  return (
    <Card sx={{}}>
      ...
      <CardActions sx={{ display: "flex", justifyContent: "space-between" }}>
        <Button
          onClick={() =>
            respond({ invitation_id: invitation.id || 0, action: "block" })
          }
          size="small"
        >
          Block sender
        ...
        <Box sx={{ flexGrow: 1 }} />
        <Button
          variant={invitation.declined === true ? "contained" : undefined}
          onClick={() =>
            respond({ invitation_id: invitation.id || 0, action: "decline" })
          }
          size="small"
        >
          Decline
        ...
        <Button
          onClick={() =>
            respond({ invitation_id: invitation.id || 0, action: "accept" })
          }
          size="small"
        >
          Accept
