...
import { Box, Button, Card, CardActionArea, CardActions, CardContent, CardHeader, Grid, IconButton, Toolbar, Typography } from "@mui/material";
import { Cottage, Create, MoreVert, PlusOne } from "@mui/icons-material";
    ...
    return (
        <>
            ...
            <Grid item sm={12} md={6} xs={12} lg={4}>
                <CreateTeamView open={createOpen} onClose={() => setCreateOpen(false)} />
                    <Card sx={{ opacity: 0.5, boxShadow: 'none', border: '1px dashed #ddd' }}>
