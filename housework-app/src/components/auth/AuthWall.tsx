import { Box, CircularProgress, Fade, Grow, Paper } from "@mui/material";
import { useGetSelfQuery } from "../../services/housework/auth";
import AuthPortal from "./AuthPortal";
import { useEffect, useMemo, useState } from "react";
import UserDetails from "./UserDetails";

export default function AuthWall({ children }: { children: JSX.Element | JSX.Element[]}) {
  ...
  >
    ...
    {(doSetup || (displayType === 'profile')) && <UserDetails handleClose={() => setDoSetup(false)} />}
